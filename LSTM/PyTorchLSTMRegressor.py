...
try:
    ...
    # Fallback for environments where the class is provided by freqtrade internals.
...
try:
    ...
    from freqtrade.freqai.torch.PyTorchModelTrainer import (
        PyTorchTransformerTrainer as PyTorchLSTMTrainer,
    )
